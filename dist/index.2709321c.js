...
specialNextBtn.addEventListener('click', ()=>{
    if (specialCurrentIndex < specialTotalSlides - 1) specialCurrentIndex++;
    else specialCurrentIndex = 0;
    updateSpecialSlider();
});
specialPrevBtn.addEventListener('click', ()=>{
    if (specialCurrentIndex > 0) specialCurrentIndex--;
    else specialCurrentIndex = specialTotalSlides - 1;
    updateSpecialSlider();
});
...
//# sourceMappingURL=index.2709321c.js.map
