...
function changePrice(id, step) {
    ...
    if (id === 'minPrice' && price > parseInt(document.getElementById('maxPrice').value, 10)) {
        price = parseInt(document.getElementById('maxPrice').value, 10);
    }
    
    if (id === 'maxPrice' && price < parseInt(document.getElementById('minPrice').value, 10)) {
        price = parseInt(document.getElementById('minPrice').value, 10);
    }
